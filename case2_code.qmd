...
results <- bind_rows(
  model_metrics(lme_all, data_lme, "data_lme"),
  model_metrics(lme_all_L, data_lme_L, "Linear dose only")
)

kable(results, digits = 3, caption = "Model Comparison: lme_all vs lme_all_L")
```
```{r}
